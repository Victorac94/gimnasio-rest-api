...
router.post('/new', [
    ...
    check('edad', 'La edad debe ser numérica y estar entre 1 y 99 años').custom(value => /^[1-9]{1,2}$/.test(value)),
    ...
    check('fk_profesor', 'El id del profesor debe ser un número').custom(value => /^[1-9]+$/.test(value)),
], (req, res) => {
    // Add new client
